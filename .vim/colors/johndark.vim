" johndark is very slightly modified onedark by joshdick https://github.com/joshdick/onedark.vim/
"
" vim:fdm=marker
" Vim Color File
" Name:       onedark.vim
...
function! johndark#set_highlight(group, style)
  call s:h(a:group, a:style)
endfunction

function! johndark#extend_highlight(group, style)
...
let s:colors = johndark#GetColors()
